...
namespace Salamtak.services.Implementation_Of_Services
{
    public class SpecialtyService : ISpecialtyService
    {
        ...
        public async Task<ApiResponse<IReadOnlyList<SpecialtyDto>>> GetAllAsync()
        {
            ...
            var result =
                _mapper.Map<IReadOnlyList<SpecialtyDto>>(
                    orderedSpecialties);

            return ApiResponse<IReadOnlyList<SpecialtyDto>>
                .Ok(result, "Specialties retrieved successfully.");
        }

        public async Task<ApiResponse<SpecialtyDto>> GetByIdAsync(
            Guid specialtyId)
        {
            ...
            return ApiResponse<SpecialtyDto>
                .Ok(result, "Specialty retrieved successfully.");
        }

        public async Task<ApiResponse<SpecialtyDto>> CreateAsync(
            CreateSpecialtyDto dto)
        {
            ...
            return ApiResponse<SpecialtyDto>
                .Ok(result, "Specialty created successfully.");
        }

        public async Task<ApiResponse<SpecialtyDto>> UpdateAsync(
            UpdateSpecialtyDto dto)
        {
            ...
            if (duplicateName)
                throw new ConflictException(
                    "Another specialty with the same name already exists.");
            ...
            return ApiResponse<SpecialtyDto>
                .Ok(result, "Specialty updated successfully.");
        }
            ...
            Guid specialtyId)
        {
            ...
            if (hasDoctors)
                throw new ConflictException(
                    "Cannot delete specialty because it is assigned to doctors.");
