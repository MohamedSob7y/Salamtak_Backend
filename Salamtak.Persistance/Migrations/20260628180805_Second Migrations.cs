        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorDocuments_Admins_VerifiedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AvailabilitySlot_EndTime_After_StartTime", "[EndTime] > [StartTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recommendations = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalReportEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalReportEntries_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalReportEntries_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalReportEntries_MedicalReports_MedicalReportId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalReportEntryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prescriptions_MedicalReportEntries_MedicalReportEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorDocuments_VerifiedByAdminId",
                table: "DoctorDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalReportEntries_AppointmentId",
                table: "MedicalReportEntries",
                column: "AppointmentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MedicalReportEntries_DoctorId",
                table: "MedicalReportEntries",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalReportEntries_MedicalReportId",
                table: "MedicalReportEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_MedicalReportEntryId",
                table: "Prescriptions",
